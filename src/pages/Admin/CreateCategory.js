                ...
                <div className="container-fluid" >
                    <div className="row">
                        ...
                        <div className="col-md-9 px-5">
                            <h1 className='ps-3 text-center text-md-start mb-3'>Manage Category</h1>
                            <div className="">
                                <CategoryForm value={name} setValue={setName} handleSubmit={handleSubmit} />
                            </div>
                            <div className='w-md-50 border px-4 py-2 rounded shadow-sm'>
                                    ...
                                    <tbody>
                                        ...
                                        {categories.map((c) => (
                                            <tr key={c._id}>
                                                <td >{c.name}</td>
                                                <td>
                                                    <button className="btn btn-success" onClick={() => { setVisible(true); setUpdatedName(c.name); setSelected(c) }}>Edit</button>
                                                    <button className="btn btn-danger ms-5" onClick={() => handleDelete(c._id)} >Delete</button>
                                                </td>
                                            </tr>
                                        ))}
